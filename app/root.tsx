...
export const links: LinksFunction = () => {
  return [
    ...
    { rel: "stylesheet", href: pizzaRemixStyles },
  ];
};
...
function RemixLogo(props: React.ComponentPropsWithoutRef<"svg">) {
  return (
    <svg
      ...
      {...props}
    >
      <title id="remix-run-logo-title">Remix Pizza</title>
...
function IconCart(props: React.ComponentPropsWithoutRef<"svg">) {
  return (
    <svg
      fill="none"
      viewBox="0 0 24 24"
...
const RouteChangeAnnouncement = React.memo(() => {
  ...
  React.useEffect(() => {
    ...
    const pageTitle =
      location.pathname === "/" ? "Remix Product Home" : document.title;
